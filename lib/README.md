...
Use [lib](/home/thinh/workspace/cytron-maker-pico/lib:1) for reusable code that should be shared across multiple example or exercise projects.
...
3. Add `add_subdirectory(my_library)` in [lib/CMakeLists.txt](/home/thinh/workspace/cytron-maker-pico/lib/CMakeLists.txt:1)
